...
###################################################################
#                             COLOR
if sys.platform in ["linux","linux2","tarmux"]:
	W = "\033[0m"
        G = '\033[32;1m'
        R = '\033[31;1m'
else:
...
def show_program():
 ...
 ------------------------------------------------------
    ...
    CodeName   B!@ck TiGER
    Version    2.0
    Date       28/05/2021 12:00:01
    Team       Hacker19
    Email      hacker19.group@gmail.com
    Facebook   @bdhacker.19
    Youtube    https://www.youtube.com/channel/UCXfdCKlmqPjyz2wKI67g9VA
...
def dump_id_id():
	...
	try:
		...
		print '[!] Error to Connected                      '
		print '[!] Stopped (Hacker19)'
#
###############################################################################
...
def main():
  ...
  try:
	...
	if cek.lower() == 'get_data':
		...
		print '\n'+'[*]  Gathering  Information [*]'.center(44) + '\n'
		search()
	elif cek.lower() == 'bot':
		menu_bot()
		bot()
...
'''
		...
		print "[!] Exiting Program Thankes For Useing our tools"
		sys.exit()
	elif cek.lower() == 'help':
		info_ga()
		main()
